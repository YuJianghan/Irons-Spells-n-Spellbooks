...
public class ModTags {
    ...
    public static final TagKey<Structure> PRIEST_WAR_MAP = TagKey.create(Registry.STRUCTURE_REGISTRY, new ResourceLocation(IronsSpellbooks.MODID, "on_priest_war_map"));
